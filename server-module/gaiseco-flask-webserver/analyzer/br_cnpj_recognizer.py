...
class BrCnpjRecognizer(PatternRecognizer):
    """
    Recognize CNPJ number using regex and checksum.

    For more information about CNPJ: https://en.wikipedia.org/wiki/CNPJ
    ...
    CONTEXT = [
        ...
        "NIRE",
        "Número de Identificação no Registro Empresarial",
        "Contrato Social",
